...
const addLog = (msg) => {
    ...
    console.log(`[BOT LOG]: ${msg}`); // Tambahan agar terlihat di log terminal
};
...
async function start() {
    ...
    sock.ev.on("connection.update", async (update) => {
        ...
        if (qr) {
            ...
            addLog("💠 QR Code baru dihasilkan, silakan scan.");
        }
        ...
        if (connection === "close") {
            ...
            isConnected = true; 
            qrCodeData = ""; 
            addLog("🟢 Bot Berhasil Terhubung dan Online!");
